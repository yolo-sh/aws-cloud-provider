...
//go:generate mockgen -destination ../mocks/user_config_env_vars_getter.go -package mocks -mock_names EnvVarsGetter=UserConfigEnvVarsGetter  github.com/yolo-sh/aws-cloud-provider/userconfig EnvVarsGetter
