...
//go:generate mockgen -destination ../mocks/user_config_profile_loader.go -package mocks -mock_names ProfileLoader=UserConfigProfileLoader github.com/yolo-sh/aws-cloud-provider/userconfig ProfileLoader
